...
_ENDPOINT_TAG = {
    ...
    ("/v1/voices", "get"): "Voices",
    ("/v1/chat/speech", "post"): "Voices",
    ...
    ("/v1/scheduled-chats", "post"): "ScheduledChats",
    ("/v1/scheduled-chats", "get"): "ScheduledChats",
    ("/v1/scheduled-chats/{id}", "get"): "ScheduledChats",
    ("/v1/scheduled-chats/{id}", "patch"): "ScheduledChats",
    ("/v1/scheduled-chats/{id}", "delete"): "ScheduledChats",
