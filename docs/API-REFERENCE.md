...
> **`ChatResponse.documents[]` ([ADR-101](adr/ADR-101-chat-response-documents.md)) — код написан, но автотестами не покрыт; ревью не проходило, в `main` не слит и на инстансы не выкачен.** На сегодняшних инстансах поля в ответе ещё нет.
