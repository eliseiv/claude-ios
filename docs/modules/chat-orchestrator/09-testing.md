...
- **Порядок слоёв ([ADR-036 §3](../../adr/ADR-036-workspaces-implementation.md)):** base-промт → суффикс `research` → `workspace.instructions` (инструкции пользователя остаются **последними**).
