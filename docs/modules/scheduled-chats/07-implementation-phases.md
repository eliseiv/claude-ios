...
2. **Phase 1 — миграция + модели:** таблица `scheduled_chat_tasks`, индексы; ORM/repository. ✅ (`migrations/versions/20260918_0035_scheduled_chat_tasks.py`, revision `0035_scheduled_chat_tasks`; `src/app/scheduled_chats/`)
