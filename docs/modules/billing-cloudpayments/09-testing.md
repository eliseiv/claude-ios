...
Обязательное покрытие — по [ADR-113 §8](../../adr/ADR-113-ru-payment-page-proxy-on-instance-domain.md) целиком (30 кейсов, каждый отдельным тестом; upstream — подменённый транспорт httpx). Кратко:
