...
- **Tech debt:** PDF на OpenAI отключён ([TD-023](../100-known-tech-debt.md)); OpenAI Responses API ([Q-033-2](../99-open-questions.md)); граница persist-формата = wire активного провайдера ([Q-033-1](../99-open-questions.md)).
