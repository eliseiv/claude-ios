...
- **Колонка источника в `subscriptions`** — вынесена владельцу ([Q-111-1](../99-open-questions.md)) и **отклонена им 2026-09-24** («Не менять схему (Recommended)»): миграция + правка всех писателей строки; риск принят как остаточный.
